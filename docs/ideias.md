...
- RECURSOS: O campo quantidadeDisponivel está definido como Int (Inteiro). Problema: Se o usuário tiver 1.5 KG de adubo, ele não consegue registrar (ou terá que converter mentalmente para 1500 G). Adubos e defensivos frequentemente usam frações.
- RECURSOS: adicionar validade? (para organicos)


ao fazer deploy para usuarios:
- determinar limite de armazenamento para cada usuario
- precificacao
- pensar em regras para funcionalidades estarem 100%
